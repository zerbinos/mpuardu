...
byte search_gyro_9250(){
  byte who_am_i_value;
  
  // Try default address first
  who_am_i_value = search_gyro(0x68, 0x75); // MPU-9250 WHO_AM_I register address
  ...
  // If not found on default address, try alternative address
  who_am_i_value = search_gyro(0x69, 0x75); // MPU-9250 WHO_AM_I register address
  ...
  // If not found on either address
  Serial.println(F("MPU-9250 not found"));
  return 0;
}
